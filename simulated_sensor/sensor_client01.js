...
setInterval(() => {
	...
	final_json["metrics"]=[{"SID":"REF01","Temperature":ref_temp},{"SID":"ACR01","Temperature":acr_temp},{"SID":"ROM01","Temperature":rom_temp}];
	...
	console.log("Sensor Client-1 to Server Data:"+JSON.stringify(final_json));
