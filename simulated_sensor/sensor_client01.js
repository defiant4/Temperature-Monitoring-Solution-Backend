...
/* sensor_client01.js
/*---------------------------------------------------------------------*/
/* Application file: sensor_client01.js                                */
...
setInterval(() => {
	...
	finalJSON["metrics"]=[{"SID":"REF01","Temperature":ref_temp},{"SID":"ACR01","Temperature":acr_temp},{"SID":"ROM01","Temperature":rom_temp}];
	...
	console.log("Sensor Client-1 to Server Data:"+JSON.stringify(finalJSON));

	//emits an event to the server identified by sensor01
	socket.emit('sensor01',finalJSON);},5000);   //5 seconds
