/*---------------------------------------------------------------------*/
/* subscribed_client02.js
/*---------------------------------------------------------------------*/
/* Application file: subscribed_client02.js                            */
...
var postJSON={"SID1":"REF02", "SID2":"ACR01", "SID3":"ROM02", "Unique":"CLIENT2"};   	//JSON object to POST data

var url= "http://localhost:6002/api/registration/3";					//Subscription POST URL to POST data
...
//	Axios POST call for subscription
	...
	.then(function (response) {
		...
		//emits an event to the server identified by the unique SERVER and CLIENT key pair
